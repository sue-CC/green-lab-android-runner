...
```{r}
# distribution
pdf("../03-plots/nor-dist.pdf", height = 4, width = 7)
par(mfrow=c(2,4))
# chrome burst
...
```{r}
# box plots of chrome
pdf("../03-plots/box-chrome.pdf", height = 4, width = 8)
par(mfrow=c(1,2))
chrome_on$frequency = factor(chrome_on$frequency, levels = c("idle", "low", "high"))
boxplot((chrome_on$Energy_trapz.J. - chrome_off$Energy_trapz.J.) ~ chrome_on$frequency, xlab = "Sending frequency", ylab = "Energy consumption")
boxplot((chrome_on2$Energy_trapz.J. - chrome_off2$Energy_trapz.J.) ~ chrome_on2$distribution, xlab = "Sending distribution pattern", ylab = "Energy consumption")
# box plots of Firefox
firefox_on$frequency = factor(chrome_on$frequency, levels = c("idle", "low", "high"))
par(mfrow=c(1,2))
boxplot((firefox_on$Energy_trapz.J. - firefox_off$Energy_trapz.J.) ~ firefox_on$frequency, xlab = "Sending frequency", ylab = "Energy consumption")
boxplot((firefox_on2$Energy_trapz.J. - firefox_off2$Energy_trapz.J.) ~ firefox_on2$distribution, xlab = "Sending distribution pattern", ylab = "Energy consumption")
dev.off()
```
